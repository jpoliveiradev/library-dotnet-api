    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Navathe", 2, new DateTime(2010, 10, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), "Banco de Dados" });

            migrationBuilder.InsertData(
                table: "Livros",
                columns: new[] { "Id", "Autor", "EditoraId", "Lancamento", "NomeLivro" },
                values: new object[] { 2, "Deitel", 3, new DateTime(2010, 10, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), "Java Prático" });

            migrationBuilder.InsertData(
                table: "Livros",
                columns: new[] { "Id", "Autor", "EditoraId", "Lancamento", "NomeLivro" },
                values: new object[] { 3, "Deitel", 3, new DateTime(2010, 10, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), "Php" });

            migrationBuilder.InsertData(
                table: "Livros",
                columns: new[] { "Id", "Autor", "EditoraId", "Lancamento", "NomeLivro" },
                values: new object[] { 4, "Cormen", 3, new DateTime(2010, 10, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), "Vue JS" });
